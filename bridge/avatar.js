...
// Scale 1.35 / lifted 0.25: the opaque crab fully encloses the (vanilla,
...
// (1.2 let the allay's wing animation poke through — user report 2026-08-08.
// Do NOT switch to an invisibility effect instead: Bedrock's crab IS the
// allay, so invisibility erases the crab for Bedrock players.)
const SKIN_NBT = `{CustomName:"Clawd",Tags:["${TAG}_skin"],billboard:"vertical",teleport_duration:2,transformation:{translation:[0f,0.25f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[1.35f,1.35f,1.35f]},item:{id:"minecraft:paper",count:1,components:{"minecraft:item_model":"clawdcraft:clawd"}}}`;
